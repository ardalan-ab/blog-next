...
//     const filenames = await fs.readFile(postsDirectory);
...
//     </AppBar>
//     <Container sx={{ mt: 4 }}>
//         <Typography variant="h1" sx={{ mb: 2 }}>Welcome to My Blog</Typography>
//         <Grid container spacing={3}>
//             {posts.map((item,i) => (
//                 <Grid item xs={12} sm={6} md={4} key={i}>

//                     <Link href={`/posts/${posts.id}`} variant="h6" color="primary">
